...
import org.hyperledger.besu.ethereum.mainnet.precompiles.daml.Namespace.DamlKeyType;
...
public class NamespaceTest {
  ...
  public void damlHashCheck() {
    assertThat(Namespace.getHash(new byte[] {0}))
        .isEqualTo(
            Bytes.fromHexString(
  ...
  public void emptyDamlStateKeyAddressCheck() {
    ...
    assertThat(Namespace.makeDamlStateKeyAddress(key).toHexString())
        .isEqualTo("0x7500c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
    assertThat(Namespace.makeAddress(DamlKeyType.STATE, key.toByteString()))
        .isEqualTo(Namespace.makeDamlStateKeyAddress(key));
  }

  @Test
  public void emptyDamlLogEntryIdAddressCheck() {
    DamlLogEntryId entryId = DamlLogEntryId.newBuilder().build();
    assertThat(Namespace.makeDamlLogEntryIdAddress(entryId).toHexString())
        .isEqualTo("0x7501c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
    assertThat(Namespace.makeAddress(DamlKeyType.LOG, entryId.toByteString()))
        .isEqualTo(Namespace.makeDamlLogEntryIdAddress(entryId));
  }
}
