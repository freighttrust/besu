 ...
 * @author scealiontach
 */
public class DamlCommitter implements Committer {
  private final Engine engine;

  /**
   * Build a DamlCommitterImpl. The Engine to be used is passed in to allow reuse since Engine
   * initialization can be costly.
   *
   * @param damlEngine the Engine to be used for this committer
   */
  public DamlCommitter(final Engine theEngine) {
  ...
  public final Tuple2<DamlLogEntry, java.util.Map<DamlStateKey, DamlStateValue>> processSubmission(
    ...
    java.util.Map<DamlStateKey, DamlStateValue> stateUpdateMap =
        scalaMapToMap(processedSubmission._2);
